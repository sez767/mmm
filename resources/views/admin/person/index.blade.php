                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'surname'">Surname</th>
                                        <th is='sortable' :column="'phone_number'">Phone Number</th>
                                        <th is='sortable' :column="'gmail'">Gmail</th>
                                ...
                                <tr v-for="(item, index) in collection.slice().reverse()" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                       ...
                                       <td >@{{ item.id }}</td>
                                        <td>
                                            <div v-if="item.new == 1"><span style="color:red">@{{ item.name }}</span></div>
                                            <div v-else><span style="color:green">@{{ item.name }}</span></div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="row no-gutters">
                                                <div class="col-auto">
                                                    <a  :href="item.resource_url + '/edit'" title="{{ trans('brackets/admin-ui::admin.btn.edit') }}" role="button"><i class="btn btn-success" ><i class="fa fa-eye" class="unread" ></i></a></i></a>
                                                </div>
